...
| Лайк                   | `70 * 800` | **56000 байт/с** |
| Просмотр постов        | `4827 * 2256000` | **10 889 712 000 байт/с** |
| Просмотр комментариев  | `4827  * 200` | **965 400 байт/с** |
| **Итого**              |          | **10 890 863 180 байт/с** = **10 890.86 МБ/с** = **87 126.88 Мбит/с** |
