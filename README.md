...
- **Требуемый объём хранилища**: 11.67 ТБ/год  
  `Расчёт: (2.96 Мбит/с × 86,400 сек/день) / 8 × 365 дней`
- **Конфигурация дисков**: SSD 2 ТБ (500 МБ/с, 1,000 IOPS)
- **Расчёт количества дисков**:
  | Критерий       | Формула                  | Результат | Дисков |
  |----------------|--------------------------|-----------|--------|
  | По ёмкости     | 11.67 ТБ ÷ 2 ТБ          | 5.84      | 6      |
...
- **Размер поста**: ~5 КБ (включая ссылки на изображения)
- **Требуемые IOPS**: 5,886.3 (аналогично SQL)
- **Требуемый объём хранилища**: 0.035 ТБ/год  
  `Расчёт: 5 КБ × 0.23 пост/сек × 86,400 сек/день × 365 дней`
- **Конфигурация дисков**: NVMe SSD 2 ТБ (3,000 МБ/с, 10,000 IOPS)
- **Расчёт количества дисков**:
  | Критерий       | Формула                  | Результат | Дисков |
  |----------------|--------------------------|-----------|--------|
  | По ёмкости     | 0.035 ТБ ÷ 2 ТБ          | 0.0175    | 1      |
